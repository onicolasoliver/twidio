...
4. **Integração** — sobe SQLite real (`:memory:`), monta a cadeia completa e confirma que o post foi persistido de verdade e que payload inválido retorna `400` sem tocar no banco.
